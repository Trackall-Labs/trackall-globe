...
export type StatusVal = "active" | "trial" | "churned" | "paused";
export type PlanVal = "free" | "pro" | "enterprise";
export type CountryVal = "US" | "CA" | "UK" | "DE" | "FR";
...
export type ChipKey = keyof ChipState;
