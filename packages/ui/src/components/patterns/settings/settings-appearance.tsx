...
export type Palette = "graphite" | "indigo" | "crimson" | "sage" | "amber" | "violet";
export type FontId = "geist" | "inter" | "mono";
...
export function ModePreview({ scheme }: { scheme: "light" | "dark" | "split" }) {
  if (scheme === "split") {
    return (
...
export function MiniChrome({ scheme }: { scheme: "light" | "dark" }) {
