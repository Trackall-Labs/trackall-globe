    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          ...
          <div className="relative h-full min-w-(--anchor-width) rounded-lg border border-border/60 bg-popover not-dark:bg-clip-padding shadow-lg/5 before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)]">
